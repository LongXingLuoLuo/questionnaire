...
public class QuestionnaireController {
    ...
    /**
     * 进入<a href="http://127.0.0.1:8090/questionnaire/visit/1">调查问卷页面</a>
     * @param questionnaireId 调查问卷的id
     * @return 调查问卷页面
     */
    @RequestMapping(value = "/visit/{questionnaireId}", method = RequestMethod.GET)
...
//        model.addAttribute("teacherList", teacherList);
    ...
    /**
     * 进入<a href="http://127.0.0.1:8090/questionnaire/answer/1">填写完成页面</a>
